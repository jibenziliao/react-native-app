/**
 *
 * @author keyy/1501718947@qq.com 17/2/15 16:55
 * @description
 */
...
import InputToolbar from 'react-native-gifted-chat/src/InputToolbar';
import LoadEarlier from 'react-native-gifted-chat/src/LoadEarlier';
import Message from 'react-native-gifted-chat/src/Message';
import MessageContainer from 'react-native-gifted-chat/src/MessageContainer';
...
class CustomGiftedChat extends React.Component {
  constructor(props) {
    super(props);
...
CustomGiftedChat.childContextTypes = {
  actionSheet: React.PropTypes.func,
  getLocale: React.PropTypes.func,
};

CustomGiftedChat.defaultProps = {
  messages: [],
  onSend: () => {
  },
  loadEarlier: false,
